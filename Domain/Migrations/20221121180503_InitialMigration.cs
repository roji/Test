        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TSQL = table.Column<string>(type: "nvarchar(4000)", nullable: false, comment: "The exact Transact-SQL statement that was executed."),
                    XmlEvent = table.Column<string>(type: "nvarchar(4000)", nullable: false, comment: "The raw XML data generated by database trigger.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IllustrationID = table.Column<int>(type: "int", nullable: false, comment: "Primary key for Illustration records.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Diagram = table.Column<string>(type: "nvarchar(4000)", nullable: true, comment: "Illustrations used in manufacturing instructions. Stored as XML."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CatalogDescription = table.Column<string>(type: "nvarchar(4000)", nullable: true, comment: "Detailed product catalog information in xml format."),
                    Instructions = table.Column<string>(type: "nvarchar(4000)", nullable: true, comment: "Manufacturing instructions in xml format."),
                    rowguid = table.Column<Guid>(type: "uniqueidentifier", nullable: false, defaultValueSql: "(newid())", comment: "ROWGUIDCOL number uniquely identifying the record. Used to support a merge replication sample."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdditionalContactInfo = table.Column<string>(type: "nvarchar(4000)", nullable: true, comment: "Additional contact information about the person stored in xml format. "),
                    Demographics = table.Column<string>(type: "nvarchar(4000)", nullable: true, comment: "Personal information such as hobbies, and income collected from online shoppers. Used for sales analysis."),
                    rowguid = table.Column<Guid>(type: "uniqueidentifier", nullable: false, defaultValueSql: "(newid())", comment: "ROWGUIDCOL number uniquely identifying the record. Used to support a merge replication sample."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrganizationLevel = table.Column<short>(type: "smallint", nullable: true, stored: false, comment: "The depth of the employee in the corporate hierarchy."),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Resume = table.Column<string>(type: "nvarchar(4000)", nullable: true, comment: "Résumé in XML format."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Demographics = table.Column<string>(type: "nvarchar(4000)", nullable: true, comment: "Demographic informationg about the store such as the number of employees, annual sales and store type."),
                    rowguid = table.Column<Guid>(type: "uniqueidentifier", nullable: false, defaultValueSql: "(newid())", comment: "ROWGUIDCOL number uniquely identifying the record. Used to support a merge replication sample."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountNumber = table.Column<string>(type: "varchar(10)", unicode: false, maxLength: 10, nullable: false, stored: false, comment: "Unique number identifying the customer assigned by the accounting system."),
                    rowguid = table.Column<Guid>(type: "uniqueidentifier", nullable: false, defaultValueSql: "(newid())", comment: "ROWGUIDCOL number uniquely identifying the record. Used to support a merge replication sample."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
